...
tbl.addEventListener('contextmenu', function(ev) {
    ...
    if (dateContents[dateContents.length - 1] === '★') {    // if there is a star, show the note popup
        alert("I had cake with my coworkers!");
    } else {    // if there isn't a star, add one (we'll edit this out of the video to make it look like it was already there)
